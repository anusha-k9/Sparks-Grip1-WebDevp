...
<body style="background: linear-gradient(90deg, rgba(159,242,175,1) 0%, rgba(149,149,218,1) 50%, rgba(213,179,207,1) 100%);">
    <!-- Navbar -->
...
<!-- End Navbar -->
  ...
  <!-- Table -->
  <div class="container">
        <h2 class="text-center pt-4" style="color : white;font-size: 40px;">TRANSACTION</h2>
            <?php
                include 'config.php';
                $sid=$_GET['id'];
        ...
        <br>
            ...
            <br><br>
                ...
                <button class="btn btn-dark" name="submit" type="submit" id="myBtn" style="margin-bottom:20px;">Transfer</button>
            </div>
        </form>
    </div>
<!-- End Table -->
